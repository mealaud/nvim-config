...
-- Bufferline
hi("BufferLineBufferSelected", { fg = colors.bg0, bg = colors.highlight3 })
-- hi("BufferLineDevIconDefaultSelected", { fg = colors.bg0, bg = colors.highlight3 })
...
hi("Visual", { fg = colors.bg0, bg = colors.highlight3 })
...
-- hi("markdownBold", )
hi("markdownH1", { fg = colors.highlight0, bold = true })
hi("markdownH2", { link = "markdownH1" })
hi("markdownH3", { fg = colors.highlight1, bold = true })
hi("markdownH4", { link = "markdownH3" })
hi("markdownH5", { fg = colors.highlight2, bold = true })
hi("markdownH6", { link = "markdownH5" })
hi("mkdURL", { bg = colors.highlight3 })
hi("mkdRule", { fg = colors.fg0})
